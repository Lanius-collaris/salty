var fs = require('fs')
  ...
  , bs58 = require('bs58')
  , resistReplayAttack=require('../patch-haha/resistReplayAttack')

function decrypt (inStream, wallet, encryptedSize, noTranslate, walletDir) {
  var self = this
  ...
  function withEphSlice (buf) {
    ...
    resistReplayAttack(walletDir,buf.slice(32,56))
    var tail
